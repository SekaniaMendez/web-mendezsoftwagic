...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    keywords: ["Software engineering", "AI engineering", "C++", "Python", "TypeScript", "Unreal Engine", "Costa Rica"],
    icons: { icon: "/images/mendez_softwagic_icon.png", apple: "/images/mendez_softwagic_icon.png" },
